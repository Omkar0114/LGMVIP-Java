...
public class Currency {
	...
	public void defaultValues() {
		...
		switch (currency) {	
			...
			case "Indian rupee":
				...
				this.exchangeValues.put("EUR", 0.08);
				this.exchangeValues.put("GBP", 0.05);
				this.exchangeValues.put("CHF", 0.08);
				this.exchangeValues.put("CNY", 0.01);
	...
	public static ArrayList<Currency> init() {
		...
		currencies.add( new Currency("Indian rupee", "rupee") );
